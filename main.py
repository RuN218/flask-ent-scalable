...
def sidebar_data():
    ...
    top_tags = db.session.query(
        Tag, func.count(tags.c.post_id).label("total")).join(tags) \
...
def post(post_id):
    ...
    return render_template("post.html", post=post, tags=tags,
                           comments=comments, recent=recent, top_tags=top_tags,
                           form=form)
...
app.add_url_rule("/generic_posts", view_func=GenericListView.as_view(
    "generic_posts", model=Post))

app.add_url_rule("/generic_users", view_func=GenericListView.as_view(
    "generic_users", model=User))

app.add_url_rule("/generic_comments", view_func=GenericListView.as_view(
